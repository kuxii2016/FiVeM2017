...
AddEventHandler('playerSpawned', function(spawn)
    if firstConnect then
        ...
        TriggerServerEvent("mm:Anderepawn")
    end
end)
...
AddEventHandler("mm:changemodel",function(model)
    ...
    Notify("~g~Player Geleaden") 
	sleep(0.7)
	TriggerClientEvent("weaponshop:playerSpawned", spawn)	
end)
...
AddEventHandler("mm:firstspawn",function()
    Notify("~g~Änder deinen Spieler im Klamottenladen!")
end)
...
function checkAnpassung()
    TriggerServerEvent("mm:checkAnpassung")
end

RegisterNetEvent("mm:Anpassungisagogogo")
AddEventHandler("mm:Anpassungisagogogo",function()
    GAnpassung()
    mp_check = true
end)

RegisterNetEvent("mm:Anpassungisanonono")
AddEventHandler("mm:Anpassungisanonono",function()
    mp_check = false
    model_info = true
    secondsRemaining = 10
...
function Main()
    DisplayHelpText("Benutze ~INPUT_CELLPHONE_UP~ ~INPUT_CELLPHONE_DOWN~ zum Blätter,und ~y~Enter~w~ zum auswählen")
    ...
    ClearMenu()
    Menu.addButton("Anpassung", "checkAnpassung", nil)
    Menu.addButton("Männlich", "MaleMenu", nil)
    Menu.addButton("Weiblich", "FemaleMenu", nil)
...
function GAnpassung()
    ...
    Menu.selection = 1
    Menu.previous = "Main"
    Menu.addButton("Männlich", "Anpassung", nil)
    Menu.addButton("Weiblich", "Anpassung", nil)
end
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--Male Menu
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function MaleMenu()
    DisplayHelpText("Benutze ~INPUT_CELLPHONE_UP~ ~INPUT_CELLPHONE_DOWN~ zum Blätter,und ~y~Enter~w~ zum auswählen")
    options.menu_subtitle = "Männlich"
    ClearMenu()
    Menu.previous = "Main"
...
function FemaleMenu()
    DisplayHelpText("Benutze ~INPUT_CELLPHONE_UP~ ~INPUT_CELLPHONE_DOWN~ zum Blätter,und ~y~Enter~w~ zum auswählen")
    options.menu_subtitle = "Weiblich"
    ClearMenu()
    Menu.previous = "Main"
...
function OtherMenu()
    ...
    ClearMenu()
    Menu.previous = "Main"
    Menu.addButton("Männlich","OtherMenuMale",nil)
    Menu.addButton("Weiblich","OtherMenuFemale",nil)  
...
function Anpassung()
    shirt_help = false
    texture_help = false
    options.menu_title = "Anpassung"
    options.menu_subtitle = "Customise your character"
    ClearMenu()
    Menu.previous = "GAnpassung"

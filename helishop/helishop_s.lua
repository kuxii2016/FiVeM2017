...
local helishop = {
	...
	menu = {
		...
		["Hubschrauber"] = {
			...
			name = "Hubschrauber",
			buttons = {
			{name = "Annihilator", costs = 10000000, description = {}, model = "annihilator"},
            {name = "Buzzard", costs = 750000, description = {}, model = "buzzard"},
            {name = "Cargobob", costs = 1000000, description = {}, model = "cargobob"},
            {name = "Frogger", costs = 850000, description = {}, model = "frogger"},
			{name = "Maverick", costs = 650000, description = {}, model = "maverick"},
            {name = "Savage", costs = 11000000, description = {}, model = "savage"},
            {name = "Skylift", costs = 15000000, description = {}, model = "skylift"},
            {name = "Super Volito", costs = 20000000, description = {}, model = "supervolito"},
            {name = "Super Volito 2", costs = 25000000, description = {}, model = "supervolito2"},
			{name = "Swift", costs = 10000000, description = {}, model = "swift"},
            {name = "Valkyrie", costs = 11000000, description = {}, model = "valkyrie"},
...
function ShowhelishopBlips(bool)
	if bool and #helishop_blips == 0 then
		for station,pos in pairs(helishop_locations) do
			...
			AddTextComponentString('Heli Händler')
...
function CloseCreator(name, heli, price)
	Citizen.CreateThread(function()
		...
		if not boughtheli then
			...
			SetVehicleHasBeenOwnedByPlayer(personalheli,true)
...
function DoesPlayerHaveVehicle(model,button,y,selected)
	...
	if t then
		drawMenuRight("Gekauft",helishop.menu.x,y,selected)
	else
...
function Back()
	...
	elseif helishop.currentmenu == "Hubschrauber" then
			...
			for i,button in pairs(menu.buttons) do
				if i >= helishop.menu.from and i <= helishop.menu.to then
					...
					if button.costs ~= nil then
						...
						if helishop.currentmenu == "Hubschrauber" then
